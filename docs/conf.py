...
casperfpga_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "casperfpga")
)
...
project = "casperfpga"
copyright = (
    "2018, Collaboration for Astronomy Signal Processing and Electronics Research"
)
...
man_pages = [(master_doc, "casperfpga", "casperfpga Documentation", [author], 1)]
